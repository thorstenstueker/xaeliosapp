 ...
 * @author Shai Almog
 */
public class XaeliosAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "XaeliosApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new XaeliosAppStub());
    }
